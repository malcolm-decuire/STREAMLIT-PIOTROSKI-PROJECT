...
st.subheader("🔎 PIOTROSKI INSIGHTS: PLD")
st.markdown("##")
...
st.subheader("e.g. For 2015 PLD got a score of 6 which indicates a buy")
...
st.subheader("e.g. For 2015 PLD got a score of 6 and a ROA of .027 which indicates a healthy company")
